...
const SavedItems: React.FC = () => {
  ...
  // Simulamos que algunos productos están en guardados
  const [savedItems, setSavedItems] = useState(MOCK_PRODUCTS.slice(0, 3));
        ...
        <div className="flex justify-between items-end mb-8 px-1">
          <div>
            ...
            <p className="text-[11px] font-bold text-vibe-sub/60 uppercase tracking-widest mt-1">
              {savedItems.length} productos bajo seguimiento
            </p>
          </div>
